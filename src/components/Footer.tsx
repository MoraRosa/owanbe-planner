...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-purple-dark via-purple to-teal-dark text-white">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {/* Brand */}
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gold via-coral to-teal flex items-center justify-center">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="#" className="text-white/70 hover:text-coral transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 text-coral">Quick Links</h4>
          ...
          {/* Event Types */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4 text-teal-light">Event Types</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            <Link to="#" className="text-white/50 hover:text-coral transition-colors">
              Privacy Policy
            </Link>
            <Link to="#" className="text-white/50 hover:text-coral transition-colors">
              Terms of Service
