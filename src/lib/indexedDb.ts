...
export const seedDemoData = async (): Promise<void> => {
  ...
  const sampleVendors: Omit<Vendor, 'id' | 'createdAt' | 'updatedAt'>[] = [
    ...
    // New vendors - Makeup Artists
    {
      userId: 'vendor-9',
      businessName: 'Glam by Funke',
      description: 'Bridal makeup specialist with expertise in Nigerian wedding looks. Flawless foundation matching for all skin tones.',
      categories: ['makeup'],
      priceRangeMin: 250,
      priceRangeMax: 800,
      currency: 'CAD',
      location: 'Hamilton, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=400'],
      rating: 4.9,
      reviewCount: 203,
      verified: true,
    },
    {
      userId: 'vendor-10',
      businessName: 'BeautyByAda',
      description: 'Celebrity makeup artist bringing Hollywood glam to your special day. Gele tying and complete bridal styling.',
      categories: ['makeup'],
      priceRangeMin: 400,
      priceRangeMax: 1200,
      currency: 'CAD',
      location: 'Mississauga, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400'],
      rating: 4.8,
      reviewCount: 156,
      verified: true,
    },
    ...
    {
      userId: 'vendor-11',
      businessName: 'Royal Ride Limos',
      description: 'Luxury limousines, party buses, and vintage cars for your grand entrance. Red carpet service included.',
      categories: ['transport'],
      priceRangeMin: 500,
      priceRangeMax: 3000,
      currency: 'CAD',
      location: 'Toronto, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=400'],
      rating: 4.7,
      reviewCount: 89,
      verified: true,
    },
    {
      userId: 'vendor-12',
      businessName: 'Prestige Event Transport',
      description: 'Fleet of luxury SUVs, Rolls Royce, and Mercedes for wedding convoys. Professional chauffeurs.',
      categories: ['transport'],
      priceRangeMin: 800,
      priceRangeMax: 5000,
      currency: 'CAD',
      location: 'Hamilton, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=400'],
      rating: 4.9,
      reviewCount: 67,
      verified: true,
    },
    ...
    {
      userId: 'vendor-13',
      businessName: 'Elegant Prints by Bimpe',
      description: 'Custom wedding invitations, save-the-dates, and programs with traditional Nigerian motifs.',
      categories: ['invitation'],
      priceRangeMin: 150,
      priceRangeMax: 1000,
      currency: 'CAD',
      location: 'Brampton, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1520854221256-17451cc331bf?w=400'],
      rating: 4.8,
      reviewCount: 112,
      verified: true,
    },
    {
      userId: 'vendor-14',
      businessName: 'Afro Design Studio',
      description: 'Digital and printed invitations, e-vites, and event websites. Modern African aesthetic designs.',
      categories: ['invitation'],
      priceRangeMin: 100,
      priceRangeMax: 600,
      currency: 'CAD',
      location: 'Toronto, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1513519245088-0e12902e35a6?w=400'],
      rating: 4.6,
      reviewCount: 78,
      verified: false,
    },
    ...
    {
      userId: 'vendor-15',
      businessName: 'Sweet Temptations GTA',
      description: 'Multi-tier wedding cakes, cupcake towers, and dessert tables. Nigerian small chops catering available.',
      categories: ['cake', 'catering'],
      priceRangeMin: 400,
      priceRangeMax: 3500,
      currency: 'CAD',
      location: 'Kitchener, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1558301211-0d8c8ddee6ec?w=400'],
      rating: 4.9,
      reviewCount: 145,
      verified: true,
    },
    ...
    {
      userId: 'vendor-16',
      businessName: 'Afrobeats Live Band',
      description: 'Live band performing Afrobeats, Juju, Highlife, and contemporary hits. Full band or acoustic duo available.',
      categories: ['entertainment', 'dj'],
      priceRangeMin: 1500,
      priceRangeMax: 6000,
      currency: 'CAD',
      location: 'Toronto, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400'],
      rating: 4.9,
      reviewCount: 56,
      verified: true,
    },
    {
      userId: 'vendor-17',
      businessName: 'Hamilton Cultural Dancers',
      description: 'Traditional Nigerian dance troupe for weddings and ceremonies. Yoruba, Igbo, and Hausa performances.',
      categories: ['entertainment'],
      priceRangeMin: 600,
      priceRangeMax: 2500,
      currency: 'CAD',
      location: 'Hamilton, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1504609773096-104ff2c73ba4?w=400'],
      rating: 4.7,
      reviewCount: 34,
      verified: true,
    },
    ...
    {
      userId: 'vendor-18',
      businessName: 'Waterfront Convention Centre',
      description: 'Stunning lakeside venue in Hamilton with capacity up to 500 guests. Full catering kitchen available.',
      categories: ['venue'],
      priceRangeMin: 3000,
      priceRangeMax: 12000,
      currency: 'CAD',
      location: 'Hamilton, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=400'],
      rating: 4.8,
      reviewCount: 98,
      verified: true,
    },
    ...
    {
      userId: 'vendor-19',
      businessName: 'Moments by Chidi',
      description: 'Documentary-style wedding photography and cinematography. Drone coverage and same-day edits available.',
      categories: ['photography', 'videography'],
      priceRangeMin: 2000,
      priceRangeMax: 7000,
      currency: 'CAD',
      location: 'Guelph, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1519741497674-611481863552?w=400'],
      rating: 4.9,
      reviewCount: 167,
      verified: true,
    },
    ...
    {
      userId: 'vendor-20',
      businessName: 'Naija Flavours Kitchen',
      description: 'Premium Nigerian catering with live cooking stations. Suya, pepper soup, and small chops specialists.',
      categories: ['catering'],
      priceRangeMin: 1000,
      priceRangeMax: 8000,
      currency: 'CAD',
      location: 'Scarborough, ON',
      portfolioImages: ['https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400'],
      rating: 4.8,
      reviewCount: 189,
      verified: true,
    },
